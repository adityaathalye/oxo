...
victory_diagonal_Xs="X X O O X O X O X"
victory_diagonal_Os="O X X O O X X O O"
...
set_board_to_values "$victory_diagonal_Xs";
if __player_wins_grid_left_diagonal __all_crosses
then echo "Player won Left Diagonal Xs!"
fi

set_board_to_values "$victory_diagonal_Os";
if __player_wins_grid_left_diagonal __all_noughts
then echo "Player won Left Diagonal Os!"
fi
